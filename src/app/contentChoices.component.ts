...
releaseTheKraken(){
  console.log('run releaseTheKraken')
  //this.cdr.markForCheck(); // duz this do anything?
  //checkAndUpdateView(); // have hopes of getting @Input refreshed
  console.log('Kraken received values here:')
  console.log(this.receivedDcFormatArray0.length)
  console.log(this.receivedDcContentChoiceArray0.length)
  console.log(this.receivedDcSkuFormatArray0.length)
  console.log(this.receivedDcFormatDetailArray0.length)
  this.loadArraysFromReceivedDaco()
  //alert('Kraken Released')
}

loadArraysFromReceivedDaco() {
  // call this func after a fetch of daco data (into the received arrays)
  // This func takes in the received arrays and sets the main arrays.
  //console.log('run loadArraysFromReceivedDaco')
  this.dateCodeFormatArray0 = this.receivedDcFormatArray0
  this.contentChoiceArray1 = this.receivedDcContentChoiceArray0
  this.skuFormatArray0 = this.receivedDcSkuFormatArray0 
  this.formatDetailArray0 = this.receivedDcFormatDetailArray0
  this.dfFilter();
}
